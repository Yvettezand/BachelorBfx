...
bwa mem Homo_sapiens.GRCh37.GATK.illumina.fasta datafiles/na12878_wes_brcagenes-1.fastq datafiles/na12878_wes_brcagenes-2.fastq > na12878_wes.sam

# Create BAM file
sambamba view -S -f bam na12878_wes.sam > na12878_wes.bam

# Sort the BAM file
sambamba sort \na12878_wes.sorted.bam
...
java -jar $GATK \
-T HaplotypeCaller \
-R Homo_sapiens.GRCh37.GATK.illumina.fasta  \
